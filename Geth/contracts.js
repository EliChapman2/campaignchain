...
const mintingAddress = '0x97667f840d5e0f4ba86516e8e576f95d41226d0e';
...
const mintingContract = new web3.eth.Contract(mintingABI, mintingAddress);

export { campaignContract, mintingContract, playerNFTContract };
